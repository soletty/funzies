      ...
      {open && (
        <div style={{ padding: "0 0.8rem 0.8rem" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: "1.25rem" }}>
            ...
            <SliderInput label="Hedge Cost" value={hedgeCostBps} onChange={onHedgeCostChange} min={0} max={200} step={1} suffix=" bps p.a. on par" hint="Hedge / swap periodic cost, paid from interest at step (F). Pre-filled from PPM extraction or back-derived from observed Q1 step (F); slider widens to 200 bps to cover cross-currency hedge stress regimes." />
